...
**Command**: <code>!generate profile &lt;name&gt;</code>
...
3. Always remember the <code>&lt;name&gt;</code> parameter if you wish to generate a new key with the same profile in the future, else the profile is lost due to encryption.
...
2. Run <code>!generate profile &lt;name&gt;</code> make sure you create a name that is easy for you to remember. It is required incase you lose your generated key.
